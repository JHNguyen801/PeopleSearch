...
namespace PeopleSearch.Controllers
{
    public class PeopleController : Controller
    {
        ...
        {
            var people = from n in _context.People
                         select n;
        ...
        public async Task<IActionResult> Create([Bind("PeopleID,Name,Address,Age,Interest")] People people)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PeopleID,Name,Address,Age,Interest")] People people)
        {
